...
exports.mapReduceUtils = {};

try
{
    ( function ( _ )
    {
        exports.mapReduceUtils = _;
...
exports.compileMapper = function ( source, name )
{
    var vm = require ( 'vm' ),
        _id, out,
        context = vm.createContext ( exports.mapReduceUtils );
...
exports.readDesignDoc = function ( doc, ViewClass )
{
    var views = {},
        object, name, m, r;
    ...
    if ( doc.views )
        for ( name in doc.views )
        {
            ...
            views [ name ] = new ViewClass ( m, r );
        }

    return views;
};

exports.readDesignDir = function ( dir, ViewClass )
{
    ...
    fs.readdirSync ( dir ).forEach ( function ( filename )
    {
        ...
        if ( doc )
        {
            views = exports.readDesignDoc ( doc, ViewClass );
            for ( name in views )
